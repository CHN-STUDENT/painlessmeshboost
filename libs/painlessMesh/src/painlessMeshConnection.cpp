...
void ICACHE_FLASH_ATTR MeshConnection::close() {
  ...
  mesh->mScheduler->deleteTask(this->timeSyncTask);
  mesh->mScheduler->deleteTask(this->nodeSyncTask);
  mesh->mScheduler->deleteTask(this->readBufferTask);
  mesh->mScheduler->deleteTask(this->sentBufferTask);
  mesh->mScheduler->deleteTask(this->timeOutTask);
